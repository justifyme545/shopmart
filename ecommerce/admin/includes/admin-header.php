...
<body class="bg-gray-100">
    <div class="flex h-screen">
        <!-- Sidebar -->
        <div class="w-64 bg-black text-white fixed h-full overflow-y-auto">
            <div class="p-6">
            ...
            <nav class="mt-6">
                ...
                <a href="products.php" class="block px-6 py-3 hover:bg-gray-800 transition <?php echo basename($_SERVER['PHP_SELF']) == 'products.php' ? 'bg-gray-800' : ''; ?>">
                    📦 Products
                </a>
